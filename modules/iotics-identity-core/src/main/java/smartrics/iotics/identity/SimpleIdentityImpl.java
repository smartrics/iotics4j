 ...
 */
public class SimpleIdentityImpl implements SimpleIdentity {
     ...
     */
    public SimpleIdentityImpl(SdkApi api, String resolverAddress) {
        this(api, resolverAddress, getValueOrThrow(api.CreateDefaultSeed()));
    }

    public SimpleIdentityImpl(SdkApi api, String resolverAddress, String seed) {
     ...
     */
    public SimpleIdentityImpl(SdkApi api, String resolverAddress, String userSeed, String agentSeed) {
    ...
    public Identity CreateTwinIdentityWithControlDelegation(Identity agentIdentity, String twinKeyName, String twinName) {
        String did = getValueOrThrow(api.CreateTwinDidWithControlDelegation(resolverAddress.toString(), agentIdentity.did(), agentIdentity.keyName(), agentIdentity.name(), agentSeed, twinKeyName, twinName));
    ...
    public String CreateAgentAuthToken(Identity agentIdentity, String userDid, String audience, Duration duration) {
        return getValueOrThrow(api.CreateAgentAuthToken(agentIdentity.did(), agentIdentity.keyName(), agentIdentity.name(), agentSeed, userDid, audience, duration.toSeconds()));
    }
    ...
    public void UserDelegatesAuthenticationToAgent(Identity agentId, Identity userId, String delegationName) {
        throwIfNotNull(api.UserDelegatesAuthenticationToAgent(resolverAddress.toString(), agentId.did(), agentId.keyName(), agentId.name(), agentSeed, userId.did(), userId.keyName(), userId.name(), userSeed, delegationName));
    ...
    public void TwinDelegatesControlToAgent(Identity agentId, Identity twinId, String delegationName) {
        throwIfNotNull(api.TwinDelegatesControlToAgent(resolverAddress.toString(), agentId.did(), agentId.keyName(), agentId.name(), agentSeed, twinId.did(), twinId.keyName(), twinId.name(), agentSeed, delegationName));
    }
